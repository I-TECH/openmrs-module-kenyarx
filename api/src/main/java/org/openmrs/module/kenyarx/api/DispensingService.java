...
public interface DispensingService {
	...
	/**
	 * Gets the dispensed order for the given drug order if there is one
	 * @param drugOrder the drug order
	 * @return the dispensed order
	 */
	DispensedOrder getDispensedOrder(DrugOrder drugOrder);

	/**
	 * Saves the given dispensed order
	 * @param dispensedOrder the dispensed order
	 */
	void saveDispensedOrder(DispensedOrder dispensedOrder);
}